...
FlClash — кроссплатформенный Clash-совместимый клиент для Android, Windows, macOS и Linux. Этот форк развивается независимо от апстрима, но продуктово сфокусирован именно на Android-направлении и служит отдельным продуктовым репозиторием: здесь живут исходники, релизы, документация и правила сопровождения.
