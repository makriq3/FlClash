...
- Сетевое ядро обновлено до Mihomo v1.19.30 с сохранением интеграции FlClash.
- Добавлена поддержка новых возможностей AmneziaWG и ZeroTier из актуальной стабильной линии ядра.
- Включены свежие исправления DNS, TLS, OpenVPN, TUN и анализа трафика.
